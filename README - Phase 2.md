...
| | |
|---|---|
| 🎬 **Phase 2 Demo Video** | [Watch the "Zero-Touch" Payout in Action](https://youtu.be/M9rWGj5rRo0?si=_vCdUPhFshFSqhFs) |
| 📖 **Installation Guide** | [From Clone to Localhost in 3 Minutes](https://youtu.be/oXs3juG8IeQ?si=iJjD5OgRAiwYxE9I) |
...
- **Desktop** (React Native) with push notifications for real-time claim alerts
- **UPI AutoPay** for frictionless weekly premium collection
- **Multi-language UI** — Hindi, Tamil, Telugu for low-literacy workers - Future Work
